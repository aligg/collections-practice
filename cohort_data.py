...
def sort_by_cohort(filename):
    ...
    for line in data:
        ...
        #print full_name
        #house = info[2]
        cohort_designation = info[4]
        #print cohort_designation
        if cohort_designation == 'Winter 2016':
            #print full_name
            winter_16.append(full_name)
        elif cohort_designation == 'Spring 2016':
            spring_16.append(full_name)
        elif cohort_designation == 'Summer 2016':
            summer_16.append(full_name)
        elif cohort_designation == 'Fall 2015':
            fall_15.append(full_name)
        elif cohort_designation == 'G':
